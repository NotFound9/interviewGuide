...
//+(void)storeVideoCommentWithHotArray:(NSMutableArray *)hotCommentArray withLatestArray:(NSMutableArray *)latestCommentArray withTotal:(NSInteger)total withID:(NSString *)ID withPage:(NSInteger)page;
