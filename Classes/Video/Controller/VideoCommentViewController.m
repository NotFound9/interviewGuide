...
//    [TTDataTool videoHotCommentWithParameters:params success:^(NSArray *hotArray, NSArray *latestArray, NSInteger total) {
//        self.hotComments = latestArray;
...
- (void)loadMoreComments
{
    ...
    //    [TTDataTool videoMoreCommentWithParameters:params success:^(NSArray *latestArray, NSInteger total) {
    //        self.hotComments = latestArray;
    //        [self.latestComments addObjectsFromArray:latestArray];
    //        self.page = page;
    //
    //        // 刷新数据
    //        [self.tableView reloadData];
