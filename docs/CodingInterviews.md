...
下面是主要是自己看完刷《剑指Offer》上题后写的题解

#### [题003-二维数组中的查找](# 题003-二维数组中的查找)

#### [题004 替换空格](#题004 替换空格)

#### [题005：从尾到头打印链表](#题005：从尾到头打印链表)
#### [题006-重建二叉树](#题006-重建二叉树)
#### [题007两个栈实现队列](#题007两个栈实现队列)
#### [题008旋转数组](#题008旋转数组)
#### [题009斐波那契数列](#题009斐波那契数列)
#### [题010求某个数的二进制格式下1的个数](#题010求某个数的二进制格式下1的个数)
#### [题011数值的整数次方](#题011数值的整数次方)
#### [题012调整数组顺序使奇数排在前面](#题012调整数组顺序使奇数排在前面)
#### [题013链表的倒数第K个结点](#题013链表的倒数第K个结点)
#### [题014反转链表](#题014反转链表)
#### [题015 合并链表](#题015合并链表)
#### [题016判断一个二叉树是否是另一个二叉树的子结构](#题016判断一个二叉树是否是另一个二叉树的子结构)
#### [题017二叉树的镜像](#题017二叉树的镜像)
#### [题018顺时针打印矩形](#题018顺时针打印矩形)
#### [题019包含min函数的栈](#题019包含min函数的栈)
#### [题020 栈的压入、弹出序列](#题020 栈的压入、弹出序列)
#### [题021 从上往下打印二叉树](#题021 从上往下打印二叉树)
#### [题022 判断是否是二叉搜索树的后序遍历](#题022 判断是否是二叉搜索树的后序遍历)
#### [题023 二叉树中和为某一值的路径](#题023 二叉树中和为某一值的路径)
#### [题024 复杂链表的复制](#题024 复杂链表的复制)
#### [题025 二叉搜索树与双向链表](#题025 二叉搜索树与双向链表)
#### [题026字符串的排列](#题026字符串的排列)
#### [题027数组中出现的次数超过一半的数字](#题027数组中出现的次数超过一半的数字)
#### [题028最小的k个数](#题028最小的k个数)
#### [题029连续子数组的最大和](#题029连续子数组的最大和)
#### [题030从1到n中出现的整数中1出现的次数](#题030从1到n中出现的整数中1出现的次数)
#### [题031把数组排成最小的数](#题031把数组排成最小的数)
#### [题032返回第N个丑数](#题032返回第N个丑数)
#### [题033 第一个只出现一次的字符](#题033 第一个只出现一次的字符)
#### [题034 数组中的逆序对](#题034 数组中的逆序对)
#### [题035 两个的链表的第一个公共节点](#题035 两个的链表的第一个公共节点)
#### [题036 数字在排序数组中出现的次数](#题036 数字在排序数组中出现的次数)
#### [题037 二叉树的深度](#题037 二叉树的深度)
#### [题038 判断是否是平衡二叉树](#题038 判断是否是平衡二叉树)
#### [题039 数组中只出现一次的数组](#题039 数组中只出现一次的数组)
#### [题040 和为S的连续正数序列](#题040 和为S的连续正数序列)
#### [题041 和为S的两个数字](#题041 和为S的两个数字)
#### [题042左旋转字符串](#题042左旋转字符串)
#### [题043 翻转单词的序列](#题043 翻转单词的序列)
#### [题044 扑克牌顺子](#题044 扑克牌顺子)
#### [题045 圆圈中最后剩下的数字](#题045 圆圈中最后剩下的数字)
#### [题046 求1+2+…+n](#题046 求1+2+…+n)
#### [题047 不用加减乘除做加法](#题047 不用加减乘除做加法)
#### [题048 将字符串转换为整数](#题048 将字符串转换为整数)
#### [题049 数组中重复的数字](#题049 数组中重复的数字)
#### [题050 构建乘积数组](#题050 构建乘积数组)
#### [题053 字符流中第一个不重复的字符](#题053 字符流中第一个不重复的字符)
#### [题054 链表中环的入口节点](#题054 链表中环的入口节点)
#### [题055 删除链表中重复的节点](#题055 删除链表中重复的节点)
#### [题056 二叉树的下一个节点](#题056 二叉树的下一个节点)
#### [题057 对称的二叉树](#题057 对称的二叉树)
#### [题058 按之字形顺序打印二叉树](#题058 按之字形顺序打印二叉树)
#### [题059 把二叉树打印成多行](#题059 把二叉树打印成多行)
#### [题060序列化二叉树](#题060序列化二叉树)
#### [题061 二叉搜索树的第K小的节点](#题061 二叉搜索树的第K小的节点)
#### [题062 数据流的中位数](#题062 数据流的中位数)
#### [题063 滑动窗口的最大值](#题063 滑动窗口的最大值)
#### [题064 矩阵中的路径](#题064 矩阵中的路径)
#### [题065机器人的运动范围](#题065机器人的运动范围)
#### [题066剪绳子](#题066剪绳子)
