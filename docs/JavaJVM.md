...
#### [7.垃圾回收算法有哪些？](#垃圾回收算法有哪些？)
#### [8.Minor GC和Full GC是什么？](#MinorGC和FullGC是什么？)
#### [9.如何确定一个对象可以回收？](#如何确定一个对象是否可以被回收？)
#### [10.目前通常使用的是什么垃圾收集器？](#目前通常使用的是什么垃圾收集器？)
#### [11.双亲委派机制是什么？](#双亲委派机制是什么？)
#### [12.怎么自定义一个类加载器？](#怎么自定义一个类加载器？)
...
##### 对于引用变动后导致漏标的情况，使用原始快照法会保存变动前的情况
