...
<img src="http://notfound9.github.io/interviewGuide/static/2332432609483-f49160c2basfdsf.jpeg" width="30%" padding-left= "20%" />
...
* MySQL
  ...
  - [MySQL相关的面试题总结](docs/MySQLNote.md)
    ...
    - [26.如何优化MySQL慢查询?](docs/MySQLNote.md# 如何优化MySQL慢查询)
    - [27.SELECT Count(*)怎么优化？](docs/MySQLNote.md#SELECT Count(*)怎么优化) 
* JVM
  ...
  - [JVM相关的面试题总结](docs/JavaJVM.md)
    ...
    - [8.Minor GC 和 Full GC是什么？](docs/JavaJVM.md#Minor GC 和 Full GC是什么)
...
<img src="http://notfound9.github.io/interviewGuide/static/image1.jpg" width="30%" padding-right= "20%" />
